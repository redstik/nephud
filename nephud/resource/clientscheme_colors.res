Scheme
{
	...
	Colors
	{
		...
		"G_LightGrey"			"234 148 182 255" // Metal color in build/destroy menu
		...
		"G_Warning"				"62 2 2 255" // Warning color
		"G_HealthValue"			"186 153 226 255" // Health value color
		"G_Overheal"			"234 148 182 255" // Overhealed health value color
		"G_LowHealthValue"		"166 96 156 255" // Low health value color
		"G_AmmoClipValue"		"234 148 182 255" // Ammo in clip value color
		"G_AmmoReserveValue"	"166 96 156 255" // Ammo in reserve value color
		"G_LowAmmo"				"144 31 165 255" // Low ammo color
		"G_MetalValue"			"234 148 182 255" // Metal color
		"G_MetalIcon"			"255 255 255 255" // Metal icon color
		"G_HeadsValue"			"186 153 226 255" // Heads value color
		"G_HeadsLabel"			"255 255 255 255" // Heads value icon color
		"G_KillstreakValue"		"20 2 62 255" // Killstreak value color
		"G_KillstreakIcon"		"255 255 255 255" // Killstreak icon color
		"G_StickyColor"					"144 31 165 255" // Stickybomb color
		...
		"G_TargetHealthValue" 			"166 96 156 255" // Target ID health value color
		...
		"G_KillfeedBlue"			"149 148 234 255" // Killfeed blue text
		"G_KillfeedRed"				"166 96 96 255" // Killfeed red text
		"G_KillfeedIcon"			"0 0 0 255" // Killfeed icon color
		"G_CustomHealthValue"		"120 120 120 255"
		"G_MainMenuOverlay"			"0 0 0 0" // Main Menu overlay color
		"G_MainMenuPanel"			"28 23 19 0" // Main Menu panel color
		"G_MainMenuButton"			"186 153 226 255" // Main Menu button color
		"G_MainMenuButtonHover"		"144 31 165 255" // Main Menu hovered button color
		...
		"G_ButtonHoverBg"			"186 153 226 255" // Button hover bg color
		"G_ButtonHoverText"			"255 255 255 255" // Button hover text color
		"G_ButtonSelectedBg"		"166 96 156 255" // Button selected bg color
		...
		"TFOrange"			"144 31 165 255" // Highlight color
	...
	BaseSettings
	{
		...
		Slider.NobColor				"144 31 165 255" // Highlight color
